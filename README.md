...
- type/description e.g. guitar, drum sticks, guitar strings, sheet music etc.
- price at which the shop bought the item.
- price at which the shop plans to sell the item.
